...
| Related Work, Benchmarks: Plasticity2D / Plasticity3D | Mohr--Coulomb return mapping, nonsmooth constitutive operators, and consistent tangents as the incremental-history reference context | `sysala2017returnmapping` | Abstract, constitutive-problem discussion, and tangent-operator sections |
| Introduction, Related Work, Benchmarks: Plasticity2D / Plasticity3D | Modified shear-strength reduction and variational / optimization viewpoints for slope stability | `sysala2021optimization` | Abstract, Davis-modification discussion, and OPT-MSSR formulation |
| Introduction, Related Work, Benchmarks: Plasticity3D | Published 3D slope-stability source-family context with continuation and iterative-solver evidence | `sysala2025advancedcontinuation` | Abstract, method sections, and reported 3D SSR source-family experiments |
| Related Work, Benchmarks: Plasticity3D | Convex optimization problems motivated by geotechnical stability analysis | `sysala2025convexoptimization` | Abstract and problem-formulation sections |
