...
this family now serves two roles. First, it remains the maintained benchmark in
...
main point is parity of the discrete solution rather than serial timing
dominance.
...
surrogate workflow, not as a constitutively equivalent replacement for a
path-consistent incremental elastoplastic history solve.

\paragraph{Derivative-route ablation.}
With that interpretation fixed, the next question is which second-order route
is the best fit for the promoted maintained workflow. On the locked
...
state-quality differences: constitutive AD is the fastest route with median
wall time \SI{221.689}{s} and median solve time \SI{190.503}{s}, compared with
\SI{288.021}{s}/\SI{254.879}{s} for element AD and
\SI{371.993}{s}/\SI{252.814}{s} for colored SFD.
