...
approximation rather than as a constitutively equivalent replacement for an
incremental elastoplastic history solve. On the
locked \code{P4(L1)}, $\lambda_{\mathrm{sr}}=1.5$, 8-rank derivative ablation,
constitutive AD is the fastest route while reaching the same terminal state as
element AD and colored SFD. A matched serial hyperelastic companion baseline
