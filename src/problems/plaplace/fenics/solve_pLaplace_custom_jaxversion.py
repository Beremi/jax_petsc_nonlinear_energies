#!/usr/bin/env python3
"""
p-Laplace 2D solver — custom Newton (JAX-version algorithm) CLI entry point.

Solver logic is in ``src/problems/plaplace/fenics/solver_custom_newton.py``.

Usage:
  Serial:   python3 src/problems/plaplace/fenics/solve_pLaplace_custom_jaxversion.py
  Parallel: mpiexec -n <nprocs> python3 src/problems/plaplace/fenics/solve_pLaplace_custom_jaxversion.py
...
def main():
    ...
    from src.problems.plaplace.fenics.solver_custom_newton import run_level
